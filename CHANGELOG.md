...
### Added
- Project-local `/brag` skill (`latent-spaces/brag`) for SAIF booth launch-video generation via Hyperframes; ignore `brag-output/` so renders stay off git.

## [0.10.8] - 2026-09-25

### Added
- Root `AGENTS.md` project guide for coding agents (layout, commands, product truth, MCP, ship pointers) beside the Next.js auto block.
...
### Changed
- Trim `registration-copy.md` to mandatory English poster fields and team Arabic notes; remove non-required email/booth chase.

## [0.10.5] - 2026-09-25

### Changed
- Fill registration-copy with team legal names, IDs, mobiles, Shadia email, and the Saif-26 Google Drive folder link.

## [0.10.4] - 2026-09-24

### Changed
- Expand registration-copy missing-data checklist, Saudi/Yemeni nationalities, and matching Arabic tables per team member.
